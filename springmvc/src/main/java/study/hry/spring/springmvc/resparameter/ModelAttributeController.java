...
public class ModelAttributeController {
	// ================ 以下两个方法是相同 ========================
	/**
	 * http://localhost:8080/springmvc/mvc/modelAttribute/query
	...
	/**
	 * 
	 * http://localhost:8080/springmvc/mvc/modelAttribute/querySame?name=aaa
	 * 
	 * @param model
	 * @param name
	 * @return
	 */
	@RequestMapping("/querySame")  
	...
	public ModelAttributeVO addModelAttribute(ModelAttributeVO modelAttribute) {
	...
	/**
	 * 此方法会先从model去获取key为"modelAttributeVO"的对象,如果获取不到会通过反射实例化一个User对象,
	 ...
	 * 
	 * 	http://localhost:8080/springmvc/mvc/modelAttribute/modelAttributeParam
	 * 
	 * @param modelAttributeVO
	 * @return
	 */
	 ...
	 * 	http://localhost:8080/springmvc/mvc/modelAttribute/modelAttributeParam2
	 * @param modelAttributeVO
	 * @return
	 */
